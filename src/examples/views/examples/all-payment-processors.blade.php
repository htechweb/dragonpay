...
<body>
	...
	<div class="row">
		<div class="col-12">
		    <form id="sample1-form" method="POST" action="{{url('dragonpay/example/payment')}}">
		    	@csrf
		        <div class="row">
		        	<div class="col">
		        		<div class="card">
		        	...
		        	<div class="col">
		        		<div class="card">
						  	<h5 class="card-header">Step 2. Select payment processor then click payment button down below.</h5>
						  	<div class="card-body">
						  		<h5 class="card-title"></h5>
						    	@include('htech.dragonpay.components.processors')
						  	</div>
